...
def generate_ai_fortune(api_key, day_name, thai_color, thai_animal, birth_time):
    ...
    try:
        ...
        text_prompt = (
            ...
            f"2.  **เส้นทางแห่งความมั่งคั่ง (การงาน-การเงิน):** ชี้แนะอาชีพที่ส่งเสริมธาตุประจำตัว ทิศทางการลงทุนที่เหมาะสม และช่วงเวลาที่ควรคว้าโอกาสหรือตั้งรับ **พร้อมทั้งมอบ 'คำคมนำทาง' ที่สร้างแรงบันดาลใจในการทำงาน 1 ประโยค**\n"
            ...
            f"หลังจากคำพยากรณ์ทั้งหมด จงสรุปใจความสำคัญในแต่ละด้าน (ภาพรวม, การงาน, ความรัก) ให้เป็นภาษาที่คนทั่วไปเข้าใจง่ายและนำไปใช้ได้ทันที โดยแยกเป็นข้อๆ\n\n"
