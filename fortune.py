...
def generate_ai_fortune(api_key, day_name, thai_color, thai_animal, birth_time):
    ...
    try:
        ...
        text_prompt = (
            ...
            f"2.  **ระดับวาสนาและคำเตือน:** จากการวิเคราะห์ทั้งหมด ให้ประเมิน 'คะแนนวาสนา' เต็ม 100 (เกณฑ์: 90+ คือดวงชะตาระดับสูง, 60-89 คือระดับปานกลาง-ดี) จากนั้นให้อธิบายถึง 'วาสนาที่ดี' หรือพรสวรรค์ที่โดดเด่นของดวงชะตานี้ แล้วจึงให้ 'คำเตือน' หรือสิ่งที่ต้องระมัดระวังเป็นพิเศษในชีวิต\n"
            f"3.  **เส้นทางแห่งความมั่งคั่ง (การงาน-การเงิน):** ชี้แนะอาชีพที่ส่งเสริมธาตุประจำตัว ทิศทางการลงทุนที่เหมาะสม และช่วงเวลาที่ควรคว้าโอกาสหรือตั้งรับ **พร้อมทั้งมอบ 'คำคมนำทาง' ที่สร้างแรงบันดาลใจในการทำงาน 1 ประโยค**\n"
            f"4.  **วาสนาแห่งรักและเครือข่ายสัมพันธ์ (ความรัก-สังคม):** วิเคราะห์ลักษณะเนื้อคู่ตามธาตุที่สมพงษ์ วิธีการเสริมสร้างเสน่ห์ และการบริหารความสัมพันธ์กับคนรอบข้าง\n"
            f"5.  **สมดุลแห่งสังขาร (สุขภาพ):** ให้คำแนะนำในการดูแลสุขภาพตามธาตุเจ้าเรือน และอวัยวะที่ต้องใส่ใจเป็นพิเศษ\n"
            f"6.  **กลยุทธ์ปรับเปลี่ยนชะตา:** แนะนำแนวทางการใช้ชีวิต การปรับสภาพแวดล้อม (ฮวงจุ้ย) หรือการใช้วัตถุมงคล/สีมงคล เพื่อปรับสมดุลธาตุและเสริมสร้างสิริมงคล\n\n"
